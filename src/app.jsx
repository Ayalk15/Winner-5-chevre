...
// מאגר כל 36 מחזורי הליגה המלאים והמתוקנים (26 ליגה סדירה + 10 מחזורי פלייאוף)
const allFixtures = {
  1: [
    ...
    { id: 5, home: 'הפועל b"ש', away: 'הפועל חיפה', time: '22/08/26' },
  ...
  2: [
    ...
    { id: 4, home: 'הפועל b"ש', away: 'הפועל ר"ג', time: '29/08/26' },
  ...
  3: [
    ...
    { id: 2, home: 'הפועal ק"ש', away: 'הפועל י-ם', time: '05/09/26' },
    { id: 3, home: 'הפועל פ"ת', away: 'מכבי חיפה', time: '05/09/26' },
    { id: 4, home: 'מכבי ת"א', away: 'הפועל b"ש', time: '05/09/26' },
  ...
  4: [
    ...
    { id: 5, home: 'הפועל b"ש', away: 'הפועל פ"ת', time: '14/09/26' },
  ...
  5: [
    ...
    { id: 3, home: 'הפועל b"ש', away: 'הפועל ק"ש', time: '19/09/26' },
  ...
  8: [
    ...
    { id: 7, home: 'מכבי חיפה', away: 'הפועל b"ש', time: '24/10/26' }
  ],
  9: [
    { id: 1, home: 'מכבי פ"ת', away: 'הפועל b"ש', time: '31/10/26' },
  ...
  10: [
    ...
    { id: 7, home: 'הפועל b"ש', away: 'הפועל ת"א', time: '07/11/26' }
  ],
  11: [
    { id: 1, home: 'מכבי פ"ת', away: 'הפועל ת"א', time: '28/11/26' },
    { id: 2, home: 'מכבי נתניה', away: 'הפועל b"ש', time: '28/11/26' },
  ...
  12: [
    ...
    { id: 6, home: 'בני סכנין', away: 'הפועל b"ש', time: '01/12/26' },
  ...
  13: [
    ...
    { id: 3, home: 'בית"ר י-ם', away: 'הפועל b"ש', time: '05/12/26' },
  ...
  14: [
    ...
    { id: 5, home: 'הפועל חיפה', away: 'הפועל b"ש', time: '12/12/26' },
  ...
  15: [
    ...
    { id: 4, home: 'הפועל b"ש', away: 'הפועל ר"ג', time: '19/12/26' },
  ...
  17: [
    ...
    { id: 5, home: 'הפועל b"ש', away: 'הפועל פ"ת', time: '02/01/27' },
  ...
  18: [
    ...
    { id: 3, home: 'הפועל ק"ש', away: 'הפועל b"ש', time: '09/01/27' },
  ...
  19: [
    ...
    { id: 6, home: 'הפועל b"ש', away: 'עירוני דורות טבריה', time: '16/01/27' },
    { id: 7, home: 'הפועל י-ם', away: 'מכבי חיפה', time: '16/01/27' }
  ],
  20: [
    { id: 1, home: 'מכבי חיפה', away: 'מכבי פ"ת', time: '23/01/27' },
    { id: 2, home: 'הפועל י-ם', away: 'הפועל b"ש', time: '23/01/27' },
  ...
  21: [
    ...
    { id: 7, home: 'הפועל b"ש', away: 'מכבי חיפה', time: '30/01/27' }
  ],
  22: [
    { id: 1, home: 'הפועל b"ש', away: 'מכבי פ"ת', time: '06/02/27' },
  ...
  23: [
    ...
    { id: 7, home: 'הפועל ת"א', away: 'הפועל b"ש', time: '13/02/27' }
  ],
  24: [
    { id: 1, home: 'הפועל ת"א', away: 'מכבי פ"ת', time: '20/02/27' },
    { id: 2, home: 'הפועל b"ש', away: 'מכבי נתניה', time: '20/02/27' },
  ...
  25: [
    ...
    { id: 6, home: 'בני סכנין', away: 'הפועל b"ש', time: '27/02/27' },
  ...
  26: [
    ...
    { id: 3, home: 'בית"ר י-ם', away: 'הפועל b"ש', time: '06/03/27' },
...
const ISRAELI_TEAMS = ['מכבי ת"א', 'מכבי חיפה', 'בית"ר י-ם', 'הפועל b"ש', 'הפועל ת"א', 'מכבי נתניה', 'הפועל חיפה', 'מכבי פ"ת', 'בני סכנין', 'עירוני דורות טבריה', 'הפועל ק"ש', 'הפועל פ"ת', 'הפועל ר"ג', 'הפועל י-ם'];

// פונקציות עזר גלובליות מחוץ לרכיב
...
export default function App() {
  ...
  // זיכרון מקומי פנימי (שומר הכל מפני רענונים)
  ...
  const [actualTournament, setActualTournament] = useState(() => JSON.parse(localStorage.getItem('actualTournament')) || { champion: '', topScorer: '', topAssists: '' });
  ...
  useEffect(() => { localStorage.setItem('actualTournament', JSON.stringify(actualTournament)); }, [actualTournament]);

  // שעון דיגיטלי חי מודגש
  useEffect(() => {
    const updateClock = () => {
      const now = new Date();
  ...
  const addPlayerGoalsByAdmin = () => {
    ...
    setAdminInputPlayer(''); setAdminInputGoals(0);
  };
  ...
  const getLiveStatistics = () => {
    ...
    return { totalPoints: matchPoints + liveScorerGoalsPoints };
  };

  const stats = getLiveStatistics();
  
  const currentMatchdayScore = () => {
    let p = 0;
    allFixtures[matchday]?.forEach(game => {
      ...
      if (actual && actual.isFinished && pred) {
        ...
        if (jokers[matchday] && String(jokers[matchday]) === String(game.id)) p *= 2;
      }
    });
    return p;
  };
      ...
      <div className="max-w-md mx-auto mt-4">
        ...
        {currentTab === 'tournament' && (
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-5 space-y-4 shadow-2xl">
            ...
            <div>
              <label className="block text-xs font-bold text-gray-400 mb-1">🎯 מלך הבישולים שלי:</label>
              ...
              <table className="w-full text-right border-collapse">
                ...
                <tbody className="divide-y divide-gray-800">
                  <tr className="bg-gray-900">
                    <td className="p-3 font-bold text-center text-xs text-gray-400 bg-gray-950/20">1 <span className="text-gray-500 mx-1">–</span></td>
        ...
        {currentTab === 'rules' && (
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 shadow-md text-sm leading-relaxed text-gray-300 space-y-3">
            ...
            <p>• <span className="text-yellow-500 font-bold">🃏 חוק הג'וקר:</span> משחק שסומן על ידך כג'וקר המחזור (אחד למחזור) יקבל כפל ניקוד (4 נק' על כיוון, 12 נק' על בול!).</p>
            <p>• <span className="text-yellow-500 font-bold">⏱️ דדליין ונעילה אוטומטית:</span> לא ניתן לנחש או לשנות ניחוש החל מיום שלפני המחזור.</p>
          </div>
        )}
      </div>
